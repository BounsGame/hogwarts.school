...
public class AvatarController {
    ...
    public ResponseEntity<byte[]> avatarFromDB(@PathVariable Long id) {
    ...
    public void avatarFromFile(@PathVariable Long id, HttpServletResponse response)
            throws IOException {
        Avatar avatar = avatarService.getAvatarById(id);
    ...
    public ResponseEntity<Page> getAvatars(@RequestParam Integer pageNumber, @RequestParam Integer pageSize) {
        Page<Avatar> avatars = avatarService.getAllPaged(pageNumber,pageSize);
